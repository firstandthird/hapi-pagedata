      ...
      handler(request, reply) {
        ...
        async.autoInject({
          ...
          dropPages(get, done) {
            ...
            const id = JSON.stringify({ siteSlug: page.site.slug, collection: page.collectionId });
            server.methods.pagedata.getPages.cache.drop(id, page.collectionId, done);
          },
          getPages(get, dropPages, done) {
            ...
            server.methods.pagedata.getPages({ siteSlug: page.site.slug, collection: page.collectionId }, done);
          },
